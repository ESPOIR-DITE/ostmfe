...
func CreatePlaceCategory(history place2.PlaceHistories) (place2.PlaceHistories, error) {
...
func UpdatePlaceCategory(history place2.PlaceHistories) (place2.PlaceHistories, error) {
	entity := place2.PlaceHistories{}
...
func ReadPlaceCategory(id string) (place2.PlaceHistories, error) {
	entity := place2.PlaceHistories{}
...
func ReadPlaceCategoryOf(placeId string) (place2.PlaceHistories, error) {
	entity := place2.PlaceHistories{}
...
func DeletePlaceCategory(id string) (place2.PlaceHistories, error) {
	entity := place2.PlaceHistories{}
...
func ReadPlaceCategories() ([]place2.PlaceHistories, error) {
	entity := []place2.PlaceHistories{}
